...
db.execute("CREATE TABLE todo (id INTEGER PRIMARY KEY, task char(100) NOT NULL, status bool NOT NULL)")
...
db.execute("CREATE TABLE daytodo (id INTEGER PRIMARY KEY, task char(100) NOT NULL, status bool NOT NULL)")
...
db.execute("CREATE TABLE nextdaytodo (id INTEGER PRIMARY KEY, task char(100) NOT NULL, status bool NOT NULL)")
...
db.execute("CREATE TABLE weektodo (id INTEGER PRIMARY KEY, task char(100) NOT NULL, status bool NOT NULL)")
...
db.execute("CREATE TABLE monthtodo (id INTEGER PRIMARY KEY, task char(100) NOT NULL, status bool NOT NULL)")
...
db.execute("CREATE TABLE overalltodo (id INTEGER PRIMARY KEY, task char(100) NOT NULL, status bool NOT NULL)")
